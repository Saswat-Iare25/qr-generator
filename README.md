...
I used a free JavaScript library for generating the qr and the rest is just basic UI stuff..
i'm still learning, so the code might not be perfect, but it works 🙂
...
Why I made This:
Since i am learning JS, CSS and HTML i thought this would be a good way to practice what i know..
also i wanted to build something that looks decent and actually works.
